"""
Django settings for scada_etl project.
...
WSGI_APPLICATION = 'scada_etl.wsgi.application'
...
#SQL
DB_SQL_SERVER=env("DB_SQL_SERVER")
DB_SQL_DATABASE=env("DB_SQL_DATABASE")
